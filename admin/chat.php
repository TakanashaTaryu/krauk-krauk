...
<div class="container mx-auto px-4 py-4 md:py-8">
    <div class="max-w-6xl mx-auto">
        <div class="flex justify-between items-center mb-4 md:mb-6">
            <h1 class="text-2xl md:text-3xl font-bold">Customer Messages</h1>
            <a href="manage_orders.php" class="text-orange-600 hover:underline inline-flex items-center text-sm md:text-base">
                <i class="fas fa-arrow-left mr-1 md:mr-2"></i> Back to Orders
            </a>
        </div>
            ...
            <select id="mobile-conversation-selector" class="w-full p-2 border rounded-md focus:outline-none focus:ring-2 focus:ring-orange-500">
                ...
                <?php foreach ($conversations as $conv): ?>
                    <option value="<?= $conv['id'] ?>" <?= ($conversation_id == $conv['id']) ? 'selected' : '' ?>>
                        Order #<?= $conv['order_id'] ?> - <?= $conv['customer_email'] ?>
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-4 md:gap-6">
            ...
            <div class="hidden md:block md:col-span-1">
                <div class="bg-white rounded-lg shadow-md p-4">
                    <h2 class="text-lg font-semibold mb-4">All Conversations</h2>
            ...
            <div class="md:col-span-3">
                ...
                <div class="bg-white rounded-lg shadow-md h-[calc(100vh-200px)] md:h-[600px] flex flex-col">
                    ...
                    <div class="p-3 md:p-4 border-b">
                        <div class="flex justify-between items-center">
                            <div>
                                <h2 class="text-base md:text-lg font-semibold">Order #<?= $conversation['order_id'] ?></h2>
                                <p class="text-xs md:text-sm text-gray-500">Customer: <?= $conversation['customer_email'] ?></p>
                ...
                <div class="bg-white rounded-lg shadow-md p-6 md:p-8 text-center">
                    ...
                    <h2 class="text-xl md:text-2xl font-semibold mb-4">No conversation selected</h2>
                    <p class="text-gray-600 mb-6">Select a conversation from the list or start a new one from the order details page.</p>
