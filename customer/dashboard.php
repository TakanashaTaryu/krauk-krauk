...
<div class="container mx-auto px-4 py-8">
    <div class="max-w-4xl mx-auto">
        <h1 class="text-3xl font-bold mb-8">Selamat Datang!</h1>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
            ...
            <div class="bg-white rounded-lg shadow p-6">
                ...
                <a href="cart.php" class="inline-block mt-4 text-orange-600 hover:underline">Lihat Keranjang →</a>
            </div>
            
            <div class="bg-white rounded-lg shadow p-6">
                <h3 class="text-xl font-bold mb-4">Quick Actions</h3>
                <div class="space-y-2">
                    <a href="menu.php" class="block text-orange-600 hover:underline">Telusuri Menu</a>
                    <a href="orders.php" class="block text-orange-600 hover:underline">Lihat Semua Pesanan</a>
                    <a href="profile.php" class="block text-orange-600 hover:underline">Update Profil</a>
        ...
        <div class="bg-white rounded-lg shadow p-6">
            ...
            <p class="text-gray-500">Kamu belum membuat pesanan.</p>
            <?php else: ?>
            <div class="space-y-4">
                ...
                <div class="border-b pb-4 last:border-b-0 last:pb-0">
                    ...
                    <div class="flex justify-between items-center">
                        <p class="text-gray-600"><?= $order['total_items'] ?> item</p>
                    ...
                    <div class="flex justify-between items-center mt-2">
                        ...
                        <a href="chat.php?order_id=<?= $order['id'] ?>" class="text-sm text-orange-600 hover:underline flex items-center">
                            <i class="fas fa-comment mr-1"></i> Chat dengan Admin
                        </a>
                    </div>
                </div>
                <?php endforeach; ?>
            ...
            <div class="mt-6 text-center">
                <a href="orders.php" class="text-orange-600 hover:underline">Lihat semua pesanan →</a>
            </div>
        </div>
    </div>
</div>
